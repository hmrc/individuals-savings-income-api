...
object RetrieveSavingsSchema {

  case object Def1 extends RetrieveSavingsSchema {
    type DownstreamResp = Def1_RetrieveSavingsResponse
    val connectorReads: Reads[DownstreamResp] = Def1_RetrieveSavingsResponse.reads
  }
