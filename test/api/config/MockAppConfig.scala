...
trait MockAppConfig extends TestSuite with MockFactory {
  ...
  object MockedAppConfig {
    ...
    def ukSavingsAccountAnnualSummaryMinimumTaxYear(year: Int): CallHandler0[Int] =
      (() => mockAppConfig.ukSavingsAccountAnnualSummaryMinimumTaxYear: Int).expects().returning(year).anyNumberOfTimes()
  ...
  trait SetupConfig {
    ...
    def setUkSavingsAccountAnnualSummaryMinimumTaxYear(): CallHandler0[Int] = MockedAppConfig.ukSavingsAccountAnnualSummaryMinimumTaxYear(2018)
